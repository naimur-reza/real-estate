...
export function findDemoUser(
  ...
  return (
    demoUsers.find((user) => {
      if (!("password" in user) || user.password !== normalizedPassword) {
        return false;
      }
...
const img = (text: string) =>
  `https://placehold.co/800x500/eaf4f8/0F2A4A?text=${encodeURIComponent(text)}`;
...
export const properties = [
  {
    ...
    status: "PUBLISHED",
    description:
      "Premium apartment with lake-facing balcony, modern fittings, and quick access to diplomatic zone offices.",
    image: img("Gulshan Lakeview"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Ready-to-move furnished flat near schools, restaurants, and major business hubs.",
    image: img("Banani Flat"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Comfortable apartment for small families with quick access to hospitals and universities.",
    image: img("Dhanmondi Apartment"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Newly completed apartment in a fast-growing residential zone with strong rental demand.",
    image: img("Mirpur Sale Apartment"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Bright corner unit close to metro rail, shopping, and schools in Sector 13.",
    image: img("Uttara Premium Flat"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Clear-title residential plot in a planned community with installment purchase option.",
    image: img("Gazipur Land Plot"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Strategic plot near the highway, suitable for long-term residential investment.",
    image: img("Savar Land Plot"),
  ...
  },
  {
    ...
    status: "PUBLISHED",
    description:
      "Efficient office space in Dhaka's commercial core with reception-ready layout.",
    image: img("Motijheel Office"),
...
export const inquiries = [
  {
    user: "Sadia Rahman",
    property: "Gulshan Lakeview Apartment",
    message: "Is it available from next month?",
    date: "May 4, 2026",
    status: "New",
  },
  {
    user: "Farhan Ahmed",
    property: "Mirpur Modern Sale Apartment",
    message: "Can I see the legal documents?",
    date: "May 3, 2026",
    status: "Read",
  },
  {
    user: "Demo User",
    property: "Gazipur Residential Land Plot",
    message: "I want installment details.",
    date: "May 2, 2026",
    status: "Replied",
  },
  {
    user: "Sadia Rahman",
    property: "Banani Furnished Family Flat",
  ...
  {
    user: "Tanvir Hossain",
    property: "Motijheel Executive Office",
    message: "Need a weekday visit slot.",
    date: "Apr 26, 2026",
    status: "Read",
  },
];
...
export const visitRequests = [
  ...
  {
    user: "Farhan Ahmed",
    property: "Uttara Premium Corner Flat",
    date: "May 16, 2026",
    time: "3:00 PM",
    status: "Pending",
  },
...
export const leads = [
  ...
  {
    user: "Tania Sultana",
    property: "Savar Highway Adjacent Plot",
    status: "New",
    source: "Website",
    note: "Needs title copy",
    updated: "May 4",
  },
];
...
export const landPurchases = [
  ...
  },
  {
    ...
    property: "Savar Highway Adjacent Plot",
    location: "Savar",
    totalPrice: "৳10,00,000",
    paid: "৳10,00,000",
    remaining: "৳0",
    installments: "8/8",
    status: "COMPLETED",
    ownership: "Ownership Granted",
  },
];
...
export const pendingProperties = [
  {
    title: "Bashundhara New Block Apartment",
  ...
  {
    title: "Mohammadpur Family Rental",
    owner: "Nusrat Owner",
    purpose: "RENT",
  ...
  {
    title: "Keraniganj Future Plot",
    owner: "Rashed Properties",
    purpose: "LAND",
